...
public class StudentAccessHelper {
    ...
    public Connection getConnection() {
        try {
            ...
            String url = "jdbc:ucanaccess://vCampus.accdb";
    ...
    public int add(Connection connection, Student stu) throws Exception {
        String sql = "insert into tb_Student(StudentID,StudentName,TeacherID,ClassID,"
                + "Major,StudentOrigion,StudentStatus,StudentGender,StudentPhone,StudentCredit) "
                + "values('" + stu.getStudentid() + "','" + stu.getStudentName() + "','" + stu.getTeacherid()
                + "','" + stu.getClassid() + "','" + stu.getMajor() + "','" + stu.getStudentorigion() + "','"
                + stu.getStudentstatus() + "','" + stu.getStudentgender() + "','" + stu.getStudentphone() + "','" + stu.getStudentcredit() + "')";
...
//			res = statement.executeUpdate("update Student set ClassID='"+ data.get(1).toString() +"' where StudentID='"+ data.get(2).toString() +"'");
                res = statement.executeUpdate("update tb_Student set ClassID='" + data.get(1).toString()
                        + "' where StudentID='" + data.get(2).toString() + "'");
                statement.close();
                con.close();
...
//			res = statement.executeUpdate("update Student set TeacherID='"+ data.get(1).toString() +"' where StudentID='"+ data.get(2).toString() +"'");
                res = statement.executeUpdate("update tb_Student set TeacherID='" + data.get(1).toString()
                        + "' where StudentID='" + data.get(2).toString() + "'");
                statement.close();
                con.close();
                System.out.println("update success");
...
//			res = statement.executeUpdate("update Student set StudentStatus='"+ data.get(1).toString() +"' where StudentID='"+ data.get(2).toString() +"'");
            ...
            case 10: {//classid + studentid + studentname + studentphone
...
//			res = statement.executeUpdate("update Student set TeacherId='"+ data.get(1).toString() +"', Major='"+ data.get(2).toString() +"' where ClassID='"+ data.get(3).toString() +"'");
            ...
            case 15: {//name, origin, phone, status, gender ---- id
